...
export const dictionaries = {
  es: {
    ...
    dash: {
      ...
      navOverview: "Resumen",
      navBot: "Mi bot",
      navBotProfile: "Perfil",
      navBotDetails: "Detalles",
      navActivity: "Actividad",
      navControl: "Control",
      configTitle: "Tu bot — configuración",
      configLead:
        "Responde unas preguntas simples. Keelra ajusta el bot por ti.",
      configBridge:
        "Tú eliges el estilo; el motor convierte eso en riesgo, mercados y forma de operar.",
      detailsLead:
        "Resumen técnico de tu cuenta. Lo gestiona Keelra según tu perfil.",
      techTitle: "Capa técnica actual",
      ...
      guidedBadge: "Perfil guiado",
      guidedTitle: "Así quieres que opere tu bot",
      guidedLead:
        "Sin tecnicismos. Responde como persona normal y Keelra ajusta el perfil interno del bot por ti.",
      guidedSave: "Guardar perfil",
      guidedModeLabel: "Estilo interno",
      guidedModeGuarded: "Más filtro antes de entrar",
      guidedModeStandard: "Más libertad para actuar",
      guidedDisclaimer:
        "Esto todavía no es ML. Por ahora ajusta riesgo y mercados de forma simple; la inteligencia avanzada del motor es la siguiente fase.",
      questionPace: "¿Cómo prefieres que se mueva el bot?",
      paceCareful: "Tranquilo",
      paceCarefulHint: "Opera menos y espera setups más limpios.",
      paceBalanced: "Equilibrado",
      paceBalancedHint: "Busca buen balance entre paciencia y oportunidad.",
      paceActive: "Activo",
      paceActiveHint: "Acepta más movimiento y revisa más setups.",
      questionStress: "¿Cuánto movimiento te hace sentir cómodo?",
      stressLow: "Muy poco",
      stressLowHint: "Prefiero proteger capital y dormir tranquilo.",
      stressMedium: "Normal",
      stressMediumHint: "Acepto variaciones moderadas si el plan es bueno.",
      stressHigh: "Bastante",
      stressHighHint: "Tolero más riesgo si hay más oportunidad.",
      questionFocus: "¿Dónde quieres que empiece a mirar el mercado?",
      focusBtc: "Solo BTC",
      focusBtcHint: "Más simple y más fácil de seguir.",
      focusMajors: "BTC y ETH",
      focusMajorsHint: "Más oportunidades dentro de los grandes.",
      questionAutonomy: "¿Qué tan libre quieres que sea el bot al decidir?",
      autoGuarded: "Con más frenos",
      autoGuardedHint: "Que solo actúe cuando lo vea muy claro.",
      autoStandard: "Más suelto",
      autoStandardHint: "Que no espere tanto si la oportunidad se ve bien.",
      keelraWillDo: "Lo que Keelra hará por detrás",
      profileSaved: "Perfil del bot actualizado",
      profileSavedHint:
        "Keelra ya ajustó el riesgo y los mercados de tu cuenta según tus respuestas.",
      profileSaveError: "No se pudo guardar el perfil",
      disclaimerTitle: "Antes de activar el bot",
      disclaimerBody:
        "Keelra es una herramienta automatizada de trading. Al activar el bot, confirmas que:\n\n• Entiendes que operar en mercados financieros conlleva riesgo de pérdida parcial o total de tu capital.\n• Keelra ejecuta operaciones según los parámetros que configuras; no garantiza ganancias.\n• Eres el único responsable de las decisiones financieras que tomes y de los fondos que destines al bot.\n• Keelra no ofrece asesoría financiera. Consulta a un profesional antes de invertir dinero que no puedas permitirte perder.",
      disclaimerAccept: "Entiendo y acepto los riesgos",
      ...
      operator: {
        ...
        calibratedTrades: "Trades en calibración",
        buckets: "Buckets calibrados",
        lastDecision: "Última decisión",
        noDecision: "Aún no hay decisiones del operador. Activa el bot o escanea el mercado.",
        blocked: "Bloqueado",
        calibrationTitle: "Calibración global por régimen",
        trades: "trades",
        winRate: "aciertos",
        notEnoughData: "pocos datos",
        regimeTrendUp: "Tendencia alcista",
        regimeTrendDown: "Tendencia bajista",
        regimeRange: "Rango / lateral",
        regimeHighVol: "Alta volatilidad",
        regimeUnknown: "Sin lectura",
      },
    },
    admin: {
      navOverview: "Resumen",
      ...
      strategyBadge: "Solo si sabes qué estás tocando",
      strategyTitle: "Motor avanzado",
      strategyLead:
        "Parámetros internos del motor (EMA, ATR, etc.). El Sandbox es para probar el bot en vivo; esto solo hace falta cuando quieras afinar el motor a fondo. Los cambios afectan a todos los bots en el próximo tick.",
      strategyName: "Nombre",
      ...
      operatorKnowledgeHide: "Ocultar lecciones",
      ...
      operatorUpdateHint:
        "Actualizar cerebro reentrena el modelo con histórico de Binance y refresca la calibración.",
      operatorToggleDone: "Estado del operador actualizado.",
      operatorUpdateDone: "Cerebro actualizado.",
      operatorLearnNav: "Aprendizaje manual",
      ...
      operatorAttachImage: "Imagen",
      operatorRemoveImage: "Quitar imagen",
      operatorTestImageInvalid: "Solo se permiten imágenes.",
      operatorTestImageTooBig: "La imagen es demasiado grande (máx. ~700KB).",
  ...
  en: {
    ...
    dash: {
      ...
      navBot: "My bot",
      navBotProfile: "Profile",
      navBotDetails: "Details",
      navActivity: "Activity",
      navControl: "Control",
      configTitle: "Your bot — configuration",
      configLead: "Answer a few simple questions. Keelra tunes the bot for you.",
      configBridge:
        "You choose the style; the engine converts it into risk, markets, and trading behavior.",
      detailsLead:
        "Technical summary of your account. Keelra manages this from your profile.",
      techTitle: "Current technical layer",
      killSwitch: "Kill switch",
      killOnLabel: "On",
      killOffLabel: "Off",
      botId: "Bot ID",
      ...
      guidedBadge: "Guided profile",
      guidedTitle: "How you want your bot to behave",
      guidedLead:
        "No jargon. Answer like a normal person and Keelra adjusts the bot's internal profile for you.",
      guidedSave: "Save profile",
      guidedModeLabel: "Internal style",
      guidedModeGuarded: "More filters before entering",
      guidedModeStandard: "More freedom to act",
      guidedDisclaimer:
        "This is not ML yet. For now it simplifies risk and market selection; advanced engine intelligence is the next phase.",
      questionPace: "How do you want the bot to move?",
      paceCareful: "Careful",
      paceCarefulHint: "Trades less and waits for cleaner setups.",
      paceBalanced: "Balanced",
      paceBalancedHint: "Looks for a solid balance of patience and opportunity.",
      paceActive: "Active",
      paceActiveHint: "Accepts more movement and reviews more setups.",
      questionStress: "How much movement are you comfortable with?",
      stressLow: "Very little",
      stressLowHint: "I prefer protecting capital and sleeping well.",
      stressMedium: "Normal",
      stressMediumHint: "I can handle moderate swings if the plan is solid.",
      stressHigh: "Quite a lot",
      stressHighHint: "I can tolerate more risk if the upside is better.",
      questionFocus: "Where should the bot start looking in the market?",
      focusBtc: "BTC only",
      focusBtcHint: "Simpler and easier to follow.",
      focusMajors: "BTC and ETH",
      focusMajorsHint: "More opportunities inside the majors.",
      questionAutonomy: "How much freedom do you want the bot to have?",
      autoGuarded: "With more brakes",
      autoGuardedHint: "Only act when it looks very clear.",
      autoStandard: "More flexible",
      autoStandardHint: "Do not wait as long if the opportunity looks good.",
      keelraWillDo: "What Keelra will do behind the scenes",
      profileSaved: "Bot profile updated",
      profileSavedHint:
        "Keelra already adjusted your account risk and markets based on your answers.",
      profileSaveError: "Could not save the profile",
      disclaimerTitle: "Before activating the bot",
      disclaimerBody:
        "Keelra is an automated trading tool. By activating the bot, you confirm that:\n\n• You understand that trading in financial markets carries the risk of partial or total loss of your capital.\n• Keelra executes trades according to the parameters you configure; it does not guarantee profits.\n• You are solely responsible for the financial decisions you make and the funds you allocate to the bot.\n• Keelra does not provide financial advice. Consult a professional before investing money you cannot afford to lose.",
      disclaimerAccept: "I understand and accept the risks",
      ...
      operator: {
        ...
        calibratedTrades: "Trades in calibration",
        buckets: "Calibrated buckets",
        lastDecision: "Last decision",
        noDecision: "No operator decisions yet. Activate the bot or scan the market.",
        blocked: "Blocked",
        calibrationTitle: "Global calibration by regime",
        trades: "trades",
        winRate: "win rate",
        notEnoughData: "not enough data",
        regimeTrendUp: "Uptrend",
        regimeTrendDown: "Downtrend",
        regimeRange: "Range / sideways",
        regimeHighVol: "High volatility",
        regimeUnknown: "No reading",
      },
    },
    admin: {
      navOverview: "Overview",
      ...
      noneYetM: "None yet.",
      viewUser: "view user",
      strategyBadge: "Only if you know what you are changing",
      strategyTitle: "Advanced engine",
      strategyLead:
        "Internal engine parameters (EMA, ATR, etc.). Use Sandbox to test the bot live; open this only when you need deep engine tuning. Changes affect every bot on the next tick.",
      strategyName: "Name",
      ...
      operatorKnowledgeHide: "Hide lessons",
      ...
      operatorUpdateHint:
        "Update brain retrains the model on Binance history and refreshes calibration.",
      operatorToggleDone: "Operator status updated.",
      operatorUpdateDone: "Brain updated.",
      operatorLearnNav: "Manual learning",
      ...
      operatorAttachImage: "Image",
      operatorRemoveImage: "Remove image",
      operatorTestImageInvalid: "Images only.",
      operatorTestImageTooBig: "Image is too large (max ~700KB).",
